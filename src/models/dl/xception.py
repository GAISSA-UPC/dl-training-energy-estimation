...
class XceptionModel(BaseModel, ABC):
    """
    Base model using the Xception architecture.
    """
    ...
    def __init__(self, *args, weights="imagenet", input_shape=None, batch_size=None, **kwargs):
        ...
        self.BASE_MODEL = Xception(weights=weights, include_top=False, input_shape=self.INPUT_SHAPE)
...
class XceptionChessLive(XceptionModel):
    """
    Model using the Xception architecture for the ChessLive dataset.
    """
